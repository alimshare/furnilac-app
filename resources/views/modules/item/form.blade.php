...
@section('content')
    ...
    <section class="content container-fluid">      
        <div class="row">
            <div class="col-xs-6">
                <form class="form-horizontal" action="/item/new" method="POST">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8"><input type="text" class="form-control" id="item_code" placeholder="Item code" name="item_code" required=""></div>
                            </div>
                            <div class="form-group">
