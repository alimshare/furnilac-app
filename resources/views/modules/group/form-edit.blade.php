                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="section" class="col-sm-2 control-label">Nama Bagian</label>
                                <div class="col-sm-10"><input type="text" class="form-control" id="section" placeholder="Nama Bagian" name="section" required=""  value="{{ $obj->section }}"></div>
                            </div>
