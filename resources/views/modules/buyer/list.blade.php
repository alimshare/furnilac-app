...
@section('content')
    ...
    <section class="content-header">
        <h1>Buyer <small>Management</small></h1>
        <ol class="breadcrumb">
            <li><a href="/home"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active"><i class="fa fa-users"></i> Buyer</li>
        </ol>
    </section>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="text-right" style="margin-bottom: 6px;">
                            <a href="/buyer/new" class="btn btn-primary btn-flat"> <i class="fa fa-plus"></i> New Buyer</a>
                                ...
                                <tbody>
                                    @foreach($list as $o)
                                        <tr>
                                            <td>{{ $o->name }}</td>
                                            <td>
                                                <a href="/buyer/edit/{{ $o->id }}" class="btn btn-primary">Edit</a>
    ...
    <form action="/buyer/delete" method="POST" id="formDelete">
        @csrf
